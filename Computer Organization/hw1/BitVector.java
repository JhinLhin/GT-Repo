...
public class BitVector
{
    ...
    // if (1 << index) = 0010 , then not (1 << index) = 1101
     ...
     */
    public boolean isSet(int index) {return index <= 31 && ((bits & (1 << index)) != 0);}
     ...
     */
    //wxyz & 0010 = 00y0, then we compare 00y0 with 0000, true if == 0 false if not cleared;
    public boolean isClear(int index) {return index >= 32 || ((bits & (1 << index)) == 0);}
