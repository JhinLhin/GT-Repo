...
// 0 means it was pressed before
// other values mean it has not been pressed
#define KEY_JUST_PRESSED(key, buttons, oldbuttons) (~KEY_DOWN(key, oldbuttons) & KET_DOWN(key, buttons)) 
