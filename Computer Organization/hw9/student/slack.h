...
typedef struct node {
    struct node* next; //this is a fixed amount maybe?
    Post* data;
} Node;
...
typedef struct channel {
    LinkedList posts;
    Account** users; // users is a pointer to an array of account struct pointers
    // Account* is the data type of the array element
    // This is an array of pointers or an array of addresses
    int numUsers;
} Channel;
